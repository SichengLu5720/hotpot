...
namespace HotpotSort.Presentation
{
    ...
    public static class Task012VisualCapture
    {
        ...
        static void Share()
        {
            ...
            var text=new GameObject("ShareTitle",typeof(RectTransform),typeof(Text));text.transform.SetParent(rect,false);var tr=(RectTransform)text.transform;tr.anchorMin=tr.anchorMax=new Vector2(0,.5f);tr.pivot=new Vector2(0,.5f);tr.sizeDelta=new Vector2(400,220);tr.anchoredPosition=new Vector2(40,0);var label=text.GetComponent<Text>();label.font=view.playerFont;label.text="一锅又一锅\n每日挑战";label.fontSize=58;label.color=new Color32(255,245,229,255);label.alignment=TextAnchor.MiddleCenter;
